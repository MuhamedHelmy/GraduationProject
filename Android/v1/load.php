...
$stmt="SELECT student_notification.Notification_ID from student_notification where student_notification.Student_ID =". $id ."";
		...
		$result2 = mysqli_query($con, $stmt2);
	    	...
	    	if (mysqli_num_rows($result2) > 0) {
			  ...
			  while($row2 = mysqli_fetch_assoc($result2)) {
				...
				{
					$stmt_1 = "SELECT student_affairs.userName from student_affairs where student_affairs.UserID=".$row2['Student_Affairs_ID']."  and student_affairs.type in ('youth_care','student_affairs')";
					...
					if($row2['Teaching_staff_id'] != null)
					{
